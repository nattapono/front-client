              ...
              <div class="tab-content" >
                ...
                <div class="tab-pane text-muted fade show active" v-else>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="py-4 box-shadow border bg-white rounded calendar pe-2" style="position:absolute;margin-left: -20px;width:380px;"
                      v-if="openMaid">
                        ...
                        <div class="col-12" v-for="(item, i) in dataMaids" :key="i">
                          <p class="d-flex align-items-center justify-content-between"
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                              ...
                              <button class="btn btn-sm btn-outline-primary text-nowrap" @click="bookMaid(item)">เลือกจอง</button>
                            </div>
                          </p>
                        </div>
                        <div v-if="dataMaids.length<1" class="text-center py-4">
                          <i class="text-muted">กำลังค้าหาแม่บ้าน..</i> 
                          <!-- <span class="text-primary cursor-pointer" @click="maidAuto">หรือเลือกอัตโนมัติ</span> -->
                        </div>
                      </div>
                    </div>
                  </div>
                                  ...
                                  <div v-if="isDateSelected(day)">
                                      <div v-for="(inDay, x) in listWorks" :key="x">
                                          ...
                                          >
                                              ...
                                              >
                                              <p class=" mb-1 font-weight-bold d-flex" v-if="dateSelect">
            ...
            <div class="form-co">
              ...
              <div class="form-group mb-2 border p-4">
                <div class="form-group mb-2">
                  ...
                  oninput="this.value = this.value.replace(/[0-9_]/g, '');"  placeholder="ชื่อนามสกุล">
                  ...
                  <table class="table border" style="min-height:250px;">
                    ...
                    <tbody>
                      ...
                      <tr v-if="payWait.hasTool === '1'">
                        <td></td>
                        <td>
                          <div class="mx-0 px-1" style="text-align-last: left;"  v-if="payWait.hasClean">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                          <div class="px-2 d-flex justify-content-between">ส่วนลด: 
                            ...
                            <div  v-if="dataPromotion" class="text-small mb-0 text-muted w-100 text-right pe-2">
                              ส่วนลด = {{dataReceipt.total_promotion_amount }} บาท
                            </div>
                        </td>
                      </tr>
                      <tr>
...
export default {
  ...
  methods: {
    ...
    handleSave: async function () {
      console.log(this.payWait.nickname);
      ...
      if(this.payWait.mppcard.length<13){
        swal({
          position: "top-center",
          icon: "info",
          title: 'กรุณากรอก เลขประจําตัวผู้เสียภาษี 13หลัก',
          showConfirmButton: false,
        });
        return false;
      }
    ...
    sendSlip: async function () {
      if(this.payWait.nickname==''){
        swal({
          position: "top-center",
          icon: "warning",
          title: 'กรุณากรอกข้อมูลผู้เสียภาษี',
          showConfirmButton: false,
        });
        return false;
      }
          ...
          .then((response) => {
            if(this.payWait){
              ...
              if(this.dataPromotion){
                ...
                console.log('dataReceipt',this.dataReceipt);
                this.saveReceipt(this.dataReceipt);
              }else{
                ...
                console.log('dataReceipt no pro',this.dataReceipt);
                this.saveReceipt(this.dataReceipt);
              }
            }
