      ...
      <div class="row d-flex justify-content-start">
          <div class="col-12 col-md-4 col-lg-3 my-2" v-for="(item, index) in dataMaids" :key="index">
            <div class="card shadow py-4 px-0 pt-0 rounded-2">
              <div class="cut-text" style="background-position:center;background-size:cover;background-image:url(../assets/images/header-maid.png);height:89px;">
              ...
              <div class="text-center h-200 p-2 " style="cursor:pointer;" @click="openMaid(item)">
                ...
                <div class="d-flex align-items-center justify-content-between mt-2">
                  ...
                  <div class="iconBx text-center d-flex align-items-center justify-content-end">
          ...
          <div class="px-4 py-2 border-top">
            ...
            <div class="row">
              <div class="col-12 bg-light my-2  px-0">
                <div class="justify-content-between my-2 px-2" v-for="(item,i) in dataMaidShow.dataComment" :key="i" :class="{ 'bg-light': i % 2 !== 0, 'bg-white': i % 2 === 0 ,'d-none':i>3,'d-flex': i<4}">
...
export default {
  ...
  methods: {
    ...
    addStart: async function (star,mid) {
      if(this.idRandom ==''){
